...
public class Deck {
    ...
    public static void main(String[] args) {
        ...
        IntStream.range(0, numCardsToDeal).forEach(new IntConsumer() {
            @Override
            public void accept(int value) {

                Card currentCard = deck.deckCards.pop();
                System.out.println(currentCard.getImageUrl());
                System.out.println(currentCard.assessImgCode());
